...
async function test1() {
    ...
    for (let i = 0; i < settings.iterations; i++) {
        await driverWithCounter.testDevices().catch(error => {
            ...
            log += error + i + " iteration, " + driverWithCounter.timers[driverWithCounter.timers.length - 1].countName + " on devices\n";
            errorCount++;
        });
        await driverWithCounter.testDashboard().catch(error => {
            ...
            log += error + i + " iteration, " + driverWithCounter.timers[driverWithCounter.timers.length - 1].countName + " on dashboard\n";
            errorCount++;
        });
        await driverWithCounter.testPersons().catch(error => {
            ...
            log += error + i + " iteration, " + driverWithCounter.timers[driverWithCounter.timers.length - 1].countName + " on persons\n";
            errorCount++;
        });
        await driverWithCounter.testEvents().catch(error => {
            ...
            log += error + i + " iteration, " + driverWithCounter.timers[driverWithCounter.timers.length - 1].countName + " on events\n";
            errorCount++;
        });
